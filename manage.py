...
#Dictionaries for table data. Each set is the contents of 1 row.
user_json = [
	{
		"name": "John Doe",
...
#This function creates the tables for the editor using the json data from earlier.
...
@cli.command()
#refreshes the database and creates the tables
def rsd():
	recreate_db()
	seeder()
